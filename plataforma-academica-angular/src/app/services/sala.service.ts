...
export class SalaService {
  ...
  listarMembros(salaId: string): Observable<string[]> {
    return this.http.get<string[]>(`${this.baseUrl}/${salaId}/membros`).pipe(catchError(this.handleError));
  }

  removerMembro(salaId: string, membroId: string, criadorId: string): Observable<void> {
  ...
  deletarAtividade(atividadeId: string, criadorId: string): Observable<void> {
