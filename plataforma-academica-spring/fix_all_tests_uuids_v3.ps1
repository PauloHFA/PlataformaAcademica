...
foreach ($file in $files) {
    ...
    # Substituir métodos que esperam UUID para Long em repositórios
    $c = $c -replace 'findByAtividadeIdAndAlunoId\(Long\.valueOf\((\d+)\), Long\.valueOf\((\d+)\)\)', 'findByAtividadeIdAndAlunoId(UUID.fromString("00000000-0000-0000-0000-00000000000$1"), UUID.fromString("00000000-0000-0000-0000-00000000000$2"))'
    $c = $c -replace 'findByAtividadeIdAndAlunoId\((\d+)L, (\d+)L\)', 'findByAtividadeIdAndAlunoId(UUID.fromString("00000000-0000-0000-0000-00000000000$1"), UUID.fromString("00000000-0000-0000-0000-00000000000$2"))'
    $c = $c -replace 'findByAtividadeIdAndAlunoId\((\d+), (\d+)\)', 'findByAtividadeIdAndAlunoId(UUID.fromString("00000000-0000-0000-0000-00000000000$1"), UUID.fromString("00000000-0000-0000-0000-00000000000$2"))'
