...
/**
 * ==========================================================================================================
 *  ATIVIDADE CONTROLLER — Plataforma Acadêmica
 * ==========================================================================================================
 * Controller responsável pela gestão completa das atividades dentro das salas virtuais da plataforma.
 *
 * As atividades representam:
 *    • Tarefas
 *    • Exercícios
 *    • Conteúdos postados pelo professor
 *    • Materiais avaliativos ou informativos
 *
 * Este controller serve como camada REST entre o frontend e o AtividadeService,
 * fornecendo endpoints para criação, edição, consulta e exclusão.
 *
 * Funcionalidades disponíveis:
 *   POST   /atividades/sala/{salaId}/autor/{autorId}   → Criar atividade na sala
 *   GET    /atividades/{atividadeId}                   → Buscar atividade por ID
 *   GET    /atividades/sala/{salaId}                   → Listar atividades da sala
 *   GET    /atividades/autor/{autorId}                 → Listar atividades criadas por um professor
 *   PUT    /atividades/{atividadeId}/autor/{autorId}   → Atualizar atividade
 *   DELETE /atividades/{atividadeId}/autor/{autorId}   → Deletar atividade
 *
 * Regras e validações importantes:
 *   • Apenas o criador da sala tem permissão para criar, editar ou apagar atividades.
 *   • Toda validação de segurança, permissão e integridade é feita exclusivamente no AtividadeService.
 *   • Este controller apenas recebe dados, delega ao service e retorna uma resposta HTTP adequada.
 *
 * Objetivo:
 *   Garantir que a comunicação com o frontend seja clara, segura e padronizada,
 *   utilizando DTOs e responses organizadas.
 *
